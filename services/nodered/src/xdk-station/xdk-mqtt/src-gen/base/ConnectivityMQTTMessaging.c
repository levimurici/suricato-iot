 ...
 */
static const char* MQTT_CLIENT_ID = "myXdk";

static const char* MQTT_BROKER_HOST = "192.168.101.28";
...
Retcode_T ConnectivityMQTTMessaging_Test_Write(char** value)
{
	...
	static char *topic = "device1/xdk110";
	...
	if (RC_OK != Mqtt_publish(&mqttSession, publishTopicDescription, *value, strlen(*value), (uint8_t) MQTT_QOS_AT_LEAST_ONCE, false))
	{
