...
#define NETWORK_SSID  "IPQ"
#define NETWORK_PSK  "inovacao"

static void ConnectivityWLANMyWifiResource_WlanConnectStatusCallback(WlanNetworkConnect_Status_T connectStatus)
{
	BCDS_UNUSED(connectStatus);
	(void) xSemaphoreGive(WlanEventSemaphore);
}
static void ConnectivityWLANMyWifiResource_NetworkIpConfigStatusCallback(WlanNetworkConfig_IpStatus_T ipStatus)
{
...
Retcode_T ConnectivityWLANMyWifiResource_Enable(void)
{
	...
	exception = WlanNetworkConnect_Init(ConnectivityWLANMyWifiResource_WlanConnectStatusCallback);
	...
	exception = WlanNetworkConfig_SetIpDhcp(ConnectivityWLANMyWifiResource_NetworkIpConfigStatusCallback);
	if(exception == NO_EXCEPTION)
	{
